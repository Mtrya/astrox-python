"""AccessComputeV2 site-to-two-body cross-validation against local Kepler geometry."""
...
def test_site_to_two_body_matches_kepler_obstruction_oracle() -> None:
    configure_astrox_from_env()
    result = compute_access(site(), two_body_entity(), step_s=300.0, compute_aer=True)
...
def main() -> int:
    try:
        test_site_to_two_body_matches_kepler_obstruction_oracle()
