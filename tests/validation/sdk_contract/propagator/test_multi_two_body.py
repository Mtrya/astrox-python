#!/usr/bin/env python3
"""Live SDK contract snapshots for the multi-two-body propagator."""
...
SNAPSHOT_PATH = Path(__file__).with_name("multi_two_body.snap.json")
...
def two_states() -> tuple[orbits.KeplerianElements, ...]:
    return propagator.multi_two_body(
...
def test_multi_two_body_sdk_contract() -> None:
    configure_astrox_from_env()
