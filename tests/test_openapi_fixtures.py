...
from scripts.openapi_fixtures.drift_pipeline_report import (
...
from scripts.openapi_fixtures.reconcile import (
...
def test_reconcile_apply_refreshes_expect_and_regenerates_status(tmp_path: Path) -> None:
    ...
    assert "Generated by scripts/openapi_fixtures/generate_status.py" in status_path.read_text(
        encoding="utf-8"
    )
