...
- [生成并检查一条 CRTBP 周期轨道](generate_a_crtbp_periodic_orbit.md)：从地月 Halo 轨道族生成周期轨道，做固定 X 修正并积分一个完整周期。
...
- [计算天体之间的 Lambert 转移窗口](compute_lambert_transfer.md)：在出发/到达时间窗口上扫描天体间的 Lambert 转移，读取转移结果与速度增量。
