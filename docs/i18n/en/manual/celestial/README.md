...
| `MinRangeAu` / `MaxRangeAu` | number | Minimum/maximum distance from the Sun along the departure-to-arrival transfer arc, in AU; includes endpoints, rather than describing the full orbit's perihelion/aphelion distances |
