...
def propagate(
    ...
    *,
    ...
    if max_propagation_time_s is not None and (
        isinstance(max_propagation_time_s, bool)
        or not isinstance(max_propagation_time_s, int)
    ):
        raise TypeError("max_propagation_time_s must be an integer or None")
...
__all__ = [
    ...
    "EpochScalar",
    "EpochStop",
    "FiniteAntiVelocityVector",
    "FiniteAttitudeControl",
    "FiniteAttitudeEuler",
    "FiniteAttitudeQuaternion",
    "FiniteManeuverSegment",
    "FiniteThrustVectorCartesian",
    "FiniteThrustVectorSpherical",
    "FiniteVelocityVector",
    "FollowSegment",
    "ImpulsiveAntiVelocityVector",
    "ImpulsiveAttitudeControl",
    "ImpulsiveAttitudeEuler",
    "ImpulsiveAttitudeQuaternion",
    "ImpulsiveManeuverSegment",
    "ImpulsiveThrustVectorCartesian",
    "ImpulsiveThrustVectorSpherical",
    "ImpulsiveVelocityVector",
    "InitialStateElement",
    "InitialStateSegment",
    "KeplerianScalar",
    "KeplerianState",
    ...
    "cartographic_scalar",
    "constant_engine",
    "delta_spherical_scalar",
    "differential_corrector",
    "differential_corrector_constraint",
    "differential_corrector_control",
    "duration_scalar",
    "duration_stop",
    "entity_path",
    "epoch_scalar",
    "epoch_stop",
    "finite_anti_velocity_vector",
    "finite_attitude_euler",
    "finite_attitude_quaternion",
    "finite_maneuver",
    "finite_thrust_vector_cartesian",
    "finite_thrust_vector_spherical",
    "finite_velocity_vector",
    "follow",
    "impulsive_anti_velocity_vector",
    "impulsive_attitude_euler",
    "impulsive_attitude_quaternion",
    "impulsive_maneuver",
    "impulsive_thrust_vector_cartesian",
    "impulsive_thrust_vector_spherical",
    "impulsive_velocity_vector",
    "initial_state",
    "keplerian_scalar",
    "keplerian_state",
    "mission_position",
    "modified_keplerian_scalar",
    "periapsis_stop",
    "point_scalar",
    "propagate",
    "relative_scalar",
